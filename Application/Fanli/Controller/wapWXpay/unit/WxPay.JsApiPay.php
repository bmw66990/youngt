...
class JsApiPay {
     ...
     * @return 用户的openid
     */
    public function GetOpenid($order_id,$money) {
        //通过code获得openid
        if (!isset($_GET['code'])) {
            //触发微信返回code码
            //$baseUrl = urlencode('http://'.$_SERVER['HTTP_HOST'].$_SERVER['PHP_SELF'].$_SERVER['QUERY_STRING']);
            //$baseUrl = 'http://wap.youngt.net/Order/wxpay/order_id/' . $_POST['order_id'];
            //$baseUrl = 'http://wap.youngt.net/Order/wxpay?order_id=' . $order_id;                    
            $baseUrl = 'http://fanli.ree9.com/Wechat/wxpay?order_id=' . $order_id.'&money='.$money;         
