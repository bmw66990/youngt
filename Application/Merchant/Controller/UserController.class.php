...
class UserController extends CommonController {
    ...
    public function accessManager() {
        ...
        $username = urldecode(I('get.username', '', 'trim'));
        ...
        $this->assign($data);
        $this->display('Partner/user_access_list');
    }
    ...
    public function accessManagerAdd() {
        ...
        if (!$operation_type) {
            ...
            $this->assign($data);
            $this->display('Partner/user_access_add_edit');
            exit;
        }
        ...
        $this->ajaxReturn(array('code' => 0,'success'=>'添加成功！'));
    }
    ...
    public function accessManagerEdit() {
        ...
        $this->ajaxReturn(array('code' => 0,'success'=>'更新成功！'));
    }
    ...
    public function accessManagerDelete() {
        ...
        $model->commit();
        $this->ajaxReturn(array('code' => 0,'success'=>'删除成功！'));
    }
    ...
    public function accessManagerdoAuth() {
        ...
        if (!$operation_type) {
            ...
            $this->assign($data);
            $this->display('Partner/user_access_do_auth');
            exit;
        }
        ...
        $model->commit();
        $this->ajaxReturn(array('code' => 0,'success'=>'授权成功！'));
    }
    ...
    public function accessManagerdoDisabled() {
        ...
        $this->ajaxReturn(array('code' => 0,'success'=>'禁用成功！'));
    }
    ...
    public function accessManagerdoRecovery() {
        ...
        $this->ajaxReturn(array('code' => 0,'success'=>'恢复成功！'));
    }
