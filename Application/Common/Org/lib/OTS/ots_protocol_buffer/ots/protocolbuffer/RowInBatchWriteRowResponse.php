...
// @@protoc_insertion_point(namespace:.ots.protocolbuffer.RowInBatchWriteRowResponse)
 ...
 */
class RowInBatchWriteRowResponse extends \ProtocolBuffers\Message
{
  // @@protoc_insertion_point(traits:.ots.protocolbuffer.RowInBatchWriteRowResponse)
  ...
  // @@protoc_insertion_point(properties_scope:.ots.protocolbuffer.RowInBatchWriteRowResponse)

  // @@protoc_insertion_point(class_scope:.ots.protocolbuffer.RowInBatchWriteRowResponse)
  ...
  public static function getDescriptor()
  {
    ...
    if (!isset($descriptor)) {
      ...
      // @@protoc_insertion_point(builder_scope:.ots.protocolbuffer.RowInBatchWriteRowResponse)
