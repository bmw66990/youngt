...
class AlipaySubmit {
	...
	function buildRequestForm($para_temp, $method, $button_name) {
		...
		$sHtml = "<div class='go-payment' style=\"display:none\"><form id='alipaysubmit' name='alipaysubmit' action='".$this->alipay_gateway_new."_input_charset=".trim(strtolower($this->alipay_config['input_charset']))."' method='".$method."'>";
	...
	function buildRequestForms($para_temp) {
		//待请求参数数组

		$sResult = $this->alipay_gateway_new;
		$para = $this->buildRequestPara($para_temp);
