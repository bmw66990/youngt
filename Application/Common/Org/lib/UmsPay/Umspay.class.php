...
class Umspay {
	...
	*/
	...
	function __construct($merchantId, $termId) {
        ...
        $this->wap_order_url = 'https://mpos.quanminfu.com:8018/umsFrontWebQmjf/umspay';
...
//debug
	...
	$transId 交易流水号
	*/
	public function queryOrder($orderId,$transId){
		$json = array(
			'ReqTime' => date('YmdHis'),
			'OrderDate' =>  date('Ymd'),
			'MerOrderId' => $orderId,
    ...
    public function buildRequestForm($param, $method, $button_name) {
        ...
        $sHtml = "<form style='display:none' id='alipaysubmit' name='alipaysubmit' action='".$this->wap_order_url."' method='".$method."'>";
