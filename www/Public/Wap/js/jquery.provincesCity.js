...
$.fn.ProvinceCity = function(){
	...
	//插入3个空的下拉框
	_self.append("<select id='province' class='num' name='province'></select>");
	_self.append("<select id='city' class='num' name='area'></select>");
	_self.append("<select id='dist' class='num' name='city'></select>");
	//分别获取3个下拉框 
