...
if(prize==39){
	...
	$('#txt').after('<a class="txtbtn" style="text-align:center" onclick="document.getElementById(\'sharemcover\').style.display=\'block\';">去分享</a>');
}else if(prize==50){
	$('#windowclosebutton').hide();
	$('.content').find('a').remove();
	$('#txt').after('<a class="txtbtn" style="text-align:center" href="#">继续抽奖</a>');
}else if(prize==88){
	$('#windowclosebutton').hide();
	$('.content').find('a').remove();
	$('#txt').after('<a class="txtbtn" style="text-align:center" href="/lottery/intro">去领奖</a>');	
}else{
	var hreff="/lottery/login/id/"+id;
	$('#windowclosebutton').hide();
	$('.content').find('a').remove();
	$('#txt').after('<a class="txtbtn" style="text-align:center" href="'+hreff+'">去领奖</a>');	
}
